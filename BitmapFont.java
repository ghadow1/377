...
public class BitmapFont extends Draw2D {
	...
	public BitmapFont(boolean flag, Archive archive, int i, String name) {
		aBoolean1496 = true;
		aBoolean1497 = true;
		anInt1498 = 3;
		anInt1499 = 3;
	...
	public void drawStringTaggableCenter(boolean flag, int i, int j, int k, int l, String s) {
	...
	public void method478(int i, int j, int k, boolean flag, String s, int l) {
		...
		if (strikethrough)
			Draw2D.method452(i1, 0x800000, k + (int) (anInt1506 * 0.69999999999999996D), j - i1, true);
	}
	...
	public void method481(byte abyte0[], int i, int j, int k, int l, int i1) {
		...
		int l1 = 0;
		int i2 = 0;
		if (j < Draw2D.anInt1427) {
			int j2 = Draw2D.anInt1427 - j;
			l -= j2;
			j = Draw2D.anInt1427;
			i2 += j2 * k;
			j1 += j2 * Draw2D.width;
		}
		if (j + l >= Draw2D.anInt1428)
			l -= ((j + l) - Draw2D.anInt1428) + 1;
		if (i < Draw2D.anInt1429) {
			int k2 = Draw2D.anInt1429 - i;
			k -= k2;
			i = Draw2D.anInt1429;
			i2 += k2;
			j1 += k2;
		...
		if (i + k >= Draw2D.anInt1430) {
			int l2 = ((i + k) - Draw2D.anInt1430) + 1;
			k -= l2;
			l1 += l2;
			k1 += l2;
		}
		if (k <= 0 || l <= 0) {
			...
			method482(Draw2D.anIntArray1424, abyte0, i1, i2, j1, k, l, k1, l1);
			return;
		}
	}
	...
	public void method483(int i, boolean flag, int j, byte abyte0[], int k, int l, int i1, int j1) {
		...
		if (k + l >= Draw2D.anInt1428)
			l -= ((k + l) - Draw2D.anInt1428) + 1;
		if (i < Draw2D.anInt1429) {
			int l2 = Draw2D.anInt1429 - i;
			i1 -= l2;
			i = Draw2D.anInt1429;
			j2 += l2;
			k1 += l2;
		...
		if (i + i1 >= Draw2D.anInt1430) {
			int i3 = ((i + i1) - Draw2D.anInt1430) + 1;
			i1 -= i3;
			i2 += i3;
			l1 += i3;
		}
		if (i1 <= 0 || l <= 0) {
			...
			method484(j2, l1, i2, k1, j1, Draw2D.anIntArray1424, j, 2, l, i1, abyte0);
			return;
		}
	}
