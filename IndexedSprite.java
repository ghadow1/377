...
public class IndexedSprite extends Draw2D {
	...
	public void blit(int i, int j, int k) {
		j += anInt1520;
		i += anInt1521;
		while (k >= 0) {
			for (int l = 1; l > 0; l++);
		}
		int i1 = j + i * Draw2D.width;
		int j1 = 0;
		int k1 = anInt1519;
		int l1 = anInt1518;
		...
		if (i < Draw2D.anInt1427) {
			int k2 = Draw2D.anInt1427 - i;
			k1 -= k2;
			i = Draw2D.anInt1427;
			j1 += k2 * l1;
			i1 += k2 * Draw2D.width;
		}
		if (i + k1 > Draw2D.anInt1428)
			k1 -= (i + k1) - Draw2D.anInt1428;
		...
		if (l1 <= 0 || k1 <= 0) {
			...
			method491(j1, Draw2D.anIntArray1424, aByteArray1516, j2, anIntArray1517, k1, l1, i1, false, i2);
			return;
		}
	}
