...
public class ItemDefinition {
	...
	public static RgbSprite method221(byte byte0, int i, int j, int k) {
		...
		int ai1[] = Draw2D.anIntArray1424;
		int l1 = Draw2D.width;
		int i2 = Draw2D.height;
		int j2 = Draw2D.anInt1429;
		int k2 = Draw2D.anInt1430;
		int l2 = Draw2D.anInt1427;
		int i3 = Draw2D.anInt1428;
		ThreeDimensionalCanvas.aBoolean1530 = false;
		Draw2D.method444(32, 32, class50_sub1_sub1_sub1_1.anIntArray1489);
		Draw2D.drawRect(32, 0, 0, (byte) -24, 32, 0);
		...
		Draw2D.method444(l1, i2, ai1);
		Draw2D.method446(l2, j2, i3, k2, true);
