...
public class JagInterface {
	...
	public static void unpack(int i, BitmapFont aclass50_sub1_sub1_sub2[], Archive archive, Archive class2_1) {
	...
	public int anInt222;
	public static BitmapFont aClass50_Sub1_Sub1_Sub2Array223[];
	...
	public int anInt235;
	public int anInt236;
	public BitmapFont aClass50_Sub1_Sub1_Sub2_237;
	public int anInt238;
