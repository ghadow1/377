...
public class MapArea {
			...
			for (int i_69_ = -5; i_69_ < anInt151 + 5; i_69_++) {
				for (int i_70_ = 0; i_70_ < anInt152; i_70_++) {
					...
					if (i_71_ >= 0 && i_71_ < anInt151) {
						...
						if (i_72_ > 0) {
							TileDefinition class15 = TileDefinition.aClass15Array314[i_72_ - 1];
					...
					if (i_73_ >= 0 && i_73_ < anInt151) {
						...
						if (i_74_ > 0) {
							TileDefinition class15 = TileDefinition.aClass15Array314[i_74_ - 1];
							anIntArray144[i_70_] -= class15.anInt323;
							anIntArray145[i_70_] -= class15.anInt321;
							anIntArray146[i_70_] -= class15.anInt322;
							anIntArray147[i_70_] -= class15.anInt324;
							...
							if (i_83_ > 0 || i_84_ > 0) {
								...
								if (i_50_ > 0) {
									...
									if (i_83_ == 0 && (aByteArrayArrayArray153[i_50_][i_69_][i_80_]) != 0)
										bool = false;
									if (i_84_ > 0 && !(TileDefinition.aClass15Array314[i_84_ - 1].aBoolean319))
										bool = false;
								...
								if (i_84_ == 0)
									...
									TileDefinition class15 = TileDefinition.aClass15Array314[i_84_ - 1];
		...
		if (!bool) {
			...
			for (;;) {
				...
				for (;;) {
					...
					int i_179_ = class50_sub1_sub2.getByte();
					int i_180_ = i_179_ >> 2;
					int i_181_ = i_179_ & 0x3;
					if (i_178_ == i_171_ && i_177_ >= i_168_ && i_177_ < i_168_ + 8 && i_176_ >= i_170_
							&& i_176_ < i_170_ + 8) {
						ObjectDefinition class47 = ObjectDefinition.forId(i_172_);
	...
	public void method173(SceneGraph class22, ClippingPlane class46, int i, int i_185_, int i_186_, byte i_187_, int i_188_,
		...
		if (!lowMemory
			...
			ObjectDefinition class47 = ObjectDefinition.forId(i_190_);
	...
	public void method183(int i, byte i_272_, int i_273_, JagBuffer class50_sub1_sub2, int i_274_, int i_275_,
		...
		if (i_275_ >= 0 && i_275_ < 104 && i_277_ >= 0 && i_277_ < 104) {
			...
			for (;;) {
				int i_278_ = class50_sub1_sub2.getByte();
				if (i_278_ == 0) {
					if (i_276_ == 0)
				...
				if (i_278_ == 1) {
					int i_279_ = class50_sub1_sub2.getByte();
					if (i_279_ == 1)
						i_279_ = 0;
					if (i_276_ == 0)
			...
			for (;;) {
				int i_280_ = class50_sub1_sub2.getByte();
				if (i_280_ == 0)
					break;
				if (i_280_ == 1) {
					class50_sub1_sub2.getByte();
