...
public class Model extends Entity {
	...
	public void method560(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		if (k3 / i3 >= Draw2D.anInt1432)
			return;
		int l3 = j3 + anInt1671 << 9;
		if (l3 / i3 <= -Draw2D.anInt1432)
			return;
		int i4 = k1 * k - j2 * j >> 16;
		int j4 = anInt1671 * j >> 16;
		int k4 = i4 + j4 << 9;
		if (k4 / i3 <= -Draw2D.anInt1433)
			return;
		int l4 = j4 + (super.height * k >> 16);
		int i5 = i4 - l4 << 9;
		if (i5 / i3 >= Draw2D.anInt1433)
			return;
			...
			if (anIntArray1659 == null || anIntArray1659[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					if ((i3 - l3) * (anIntArray1687[j2] - anIntArray1687[k1])
						...
						if (i3 < 0 || l3 < 0 || k4 < 0 || i3 > Draw2D.anInt1431
								|| l3 > Draw2D.anInt1431 || k4 > Draw2D.anInt1431)
	...
	public void method601(int i) {
		...
		if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			...
			if (l == 3) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Draw2D.anInt1431 || j4 > Draw2D.anInt1431
						|| j5 > Draw2D.anInt1431)
			...
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Draw2D.anInt1431 || j4 > Draw2D.anInt1431
						|| j5 > Draw2D.anInt1431 || anIntArray1699[3] < 0
						|| anIntArray1699[3] > Draw2D.anInt1431)
					ThreeDimensionalCanvas.aBoolean1528 = true;
				int i8;
				if (anIntArray1659 == null)
					i8 = 0;
