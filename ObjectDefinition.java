...
public class ObjectDefinition {
	...
	public Model method427(int i, int j, int k, int l) {
		...
		Model class50_sub1_sub4_sub4_3 = new Model(i == 0 && j == -1 && !flag
				&& !flag2, false, anIntArray799 == null, class50_sub1_sub4_sub4, Class21.method239(j));
		if (k != 0)
			anInt768 = 487;
		if (j != -1) {
		...
		if (anIntArray799 != null) {
			for (int k2 = 0; k2 < anIntArray799.length; k2++)
				class50_sub1_sub4_sub4_3.replaceColor(anIntArray799[k2], anIntArray792[k2]);
