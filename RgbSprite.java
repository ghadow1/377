...
public class RgbSprite extends Draw2D {
	...
	public void method456(boolean flag) {
		if (flag) {
			...
			Draw2D.method444(anInt1490, anInt1491, anIntArray1489);
			return;
		}
	}
	...
	public void method459(int i, int j, int k) {
		...
		int i2 = 0;
		if (i < Draw2D.anInt1427) {
			int j2 = Draw2D.anInt1427 - i;
			j1 -= j2;
			i = Draw2D.anInt1427;
			i1 += j2 * k1;
			l += j2 * Draw2D.width;
		}
		if (i + j1 > Draw2D.anInt1428)
			j1 -= (i + j1) - Draw2D.anInt1428;
		if (k < Draw2D.anInt1429) {
			int k2 = Draw2D.anInt1429 - k;
			k1 -= k2;
			k = Draw2D.anInt1429;
			i1 += k2;
			l += k2;
		...
		if (k + k1 > Draw2D.anInt1430) {
			int l2 = (k + k1) - Draw2D.anInt1430;
			k1 -= l2;
			i2 += l2;
			l1 += l2;
		}
		if (k1 <= 0 || j1 <= 0)
			return;
		method460(k1, l1, j1, anIntArray1489, i1, i2, l, (byte) -39, Draw2D.anIntArray1424);
		if (j >= 0)
			aBoolean1487 = !aBoolean1487;
	}
	...
	public void method461(int i, int j, int k) {
		...
		if (i + j1 > Draw2D.anInt1428)
			j1 -= (i + j1) - Draw2D.anInt1428;
		if (j < Draw2D.anInt1429) {
			int k2 = Draw2D.anInt1429 - j;
			k1 -= k2;
			j = Draw2D.anInt1429;
			i1 += k2;
			l += k2;
		...
		if (j + k1 > Draw2D.anInt1430) {
			int l2 = (j + k1) - Draw2D.anInt1430;
			k1 -= l2;
			i2 += l2;
			l1 += l2;
		}
		if (k1 <= 0 || j1 <= 0) {
			...
			method462(Draw2D.anIntArray1424, anIntArray1489, 0, i1, l, k1, j1, l1, i2);
			return;
		}
	}
	...
	public void method463(int i, int j, int k, int l) {
		...
		int j2 = 0;
		if (k < Draw2D.anInt1427) {
			int k2 = Draw2D.anInt1427 - k;
			k1 -= k2;
			k = Draw2D.anInt1427;
			j1 += k2 * l1;
			i1 += k2 * Draw2D.width;
		}
		if (k + k1 > Draw2D.anInt1428)
			k1 -= (k + k1) - Draw2D.anInt1428;
		if (j < Draw2D.anInt1429) {
			int l2 = Draw2D.anInt1429 - j;
			l1 -= l2;
			j = Draw2D.anInt1429;
			j1 += l2;
			i1 += l2;
		...
		if (j + l1 > Draw2D.anInt1430) {
			int i3 = (j + l1) - Draw2D.anInt1430;
			l1 -= i3;
			j2 += i3;
			i2 += i3;
		}
		if (l1 <= 0 || k1 <= 0) {
			...
			method464(l1, j2, 0, i2, j1, anInt1481, l, i1, k1, Draw2D.anIntArray1424, anIntArray1489);
			return;
		}
	}
	...
	public void method465(int i, int j, int k, int l, int i1, int ai[], int j1, int k1, int l1, int ai1[], int i2) {
		...
		try {
			...
			for (i = 0; i < k; i++) {
				...
				int l4 = k3 - l2 * i4;
				for (j1 = -ai[i]; j1 < 0; j1++) {
					Draw2D.anIntArray1424[j4++] = anIntArray1489[(k4 >> 16) + (l4 >> 16) * anInt1490];
					k4 += i3;
					l4 -= l2;
				}
	...
	public void method467(IndexedSprite class50_sub1_sub1_sub3, int i, int j, int k) {
		...
		if (k1 <= 0 || j1 <= 0) {
			...
			method468(l, l1, anIntArray1489, k1, Draw2D.anIntArray1424,
