...
public class TileDefinition {
	...
	public static void unpack(Archive class2) {
		JagBuffer class50_sub1_sub2 = new JagBuffer(class2.get("flo.dat"));
		anInt313 = class50_sub1_sub2.getShort();
		if (aClass15Array314 == null)
			aClass15Array314 = new TileDefinition[anInt313];
		for (int j = 0; j < anInt313; j++) {
			if (aClass15Array314[j] == null)
				aClass15Array314[j] = new TileDefinition();
			aClass15Array314[j].method208(aByte310, class50_sub1_sub2);
		}

	}

	public void method208(byte byte0, JagBuffer class50_sub1_sub2) {
		if (byte0 == 6) {
			byte0 = 0;
		} else {
			for (int i = 1; i > 0; i++);
		...
		do {
			...
			if (j == 1) {
				...
				anInt317 = class50_sub1_sub2.getByte();
			else if (j == 3)
				aBoolean318 = true;
			else if (j == 5)
				aBoolean319 = false;
	...
	public static TileDefinition aClass15Array314[];
