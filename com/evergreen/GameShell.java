...
public abstract class GameShell extends JComponent implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    // Added for Evergreen
    public boolean controlKeyActive;

    public boolean pKeyActive;
    public boolean oKeyActive;
    public boolean altKeyActive;
    ...
    public void run() {
        try {
            ...
            handleProgressBarDisplay(0, "Loading...");
            load();
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        //..Test drag minimap
        //..Game.instance.uiExtension.minimap.setNsXPos(x);
        //..Game.instance.uiExtension.minimap.setNsYPos(y);

        System.out.println("Mouse dragged... mouseX = " + x + " ... mouseY = " + y);
    }
    ...
    public float LOADING_PROGRESS_FLOAT;

    public void handleProgressBarDisplay(int percent, String message) {
        for (float f = LOADING_PROGRESS_FLOAT; f < (float) percent; f = (float) ((double) f + 0.29999999999999999D)) {
            drawProgress((int) f, message);
        }
        LOADING_PROGRESS_FLOAT = percent;
    }
